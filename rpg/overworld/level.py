...
from sprites import Wall, Floor, Shadow
            ...
            for col_index, tile in enumerate(row):
                ...
                if type == "terrain":
                    ...
                    if tile != "-1" and tile != "21":
                        Wall(self.overworld, x, y, tile_surface)
                    elif tile == "21":
                        Floor(self.overworld, x, y, tile_surface)
                
                elif type == "shadows":
                    shadow_tile_list = import_cut_graphic("assets/terrain/terrain.png")
                    tile_surface = shadow_tile_list[int(tile)]
                    # Shadow(self.overworld, x, y, tile_surface) # issue with image transparency
